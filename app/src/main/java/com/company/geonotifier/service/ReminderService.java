...
import static com.company.geonotifier.App.CHANNEL_ID;

public class ReminderService extends Service implements LocationListener {

    public static final String REMINDER_SERVICE_DESTROYED = "com.company.geonotifier.REMINDER_SERVICE_DESTROYED";
